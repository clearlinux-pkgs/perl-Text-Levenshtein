...
Requires: perl-Text-Levenshtein-man
...
%package man
Summary: man components for the perl-Text-Levenshtein package.
Group: Default

%description man
man components for the perl-Text-Levenshtein package.
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Text/Levenshtein.pm
