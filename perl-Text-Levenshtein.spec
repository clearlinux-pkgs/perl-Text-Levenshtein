...
%prep
%setup -q -n Text-Levenshtein-0.15
cd %{_builddir}/Text-Levenshtein-0.15
...
cp %{_builddir}/Text-Levenshtein-0.15/LICENSE %{buildroot}/usr/share/package-licenses/perl-Text-Levenshtein/ac6003ce40240de25b30d7e17ee93cb8616443be
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/Text/Levenshtein.pm
